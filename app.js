...
generateEl.addEventListener(`click`, () => {
    ...
    // The generatePassword function takes the true/false values determined by the checkboxes as well as the number from the number input as arguments and returns a string (AKA The generated password)
    // which is set as the value for the innerText property for the result element/span
...
clipboardEl.addEventListener(`click`, () => {
    ...
    // Setting the value for the textArea to the password thay is currently being displayed
